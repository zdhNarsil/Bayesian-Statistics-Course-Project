function [Regret] = draw(data, set, info)
...
if set == 1
for i = 1:num
    Regret(:, 1) = Regret(:, 1) + Thompson1(data, 0)/num;
    fprintf("%d %d\n", j, i);
end
j = j + 1;
for i = 1:num
    Regret(:, 2) = Regret(:, 2) + Thompson1(data, 1)/num;
    fprintf("%d %d\n", j, i);
end
j = j + 1;
for i = 1:num
    Regret(:, 3) = Regret(:, 3) + Thompson1_ensemble(data, N, 0)/num;
    fprintf("%d %d\n", j, i);
end
j = j + 1;
for i = 1:num
    Regret(:, 4) = Regret(:, 4) + Thompson1_ensemble(data, N, 1)/num;
    fprintf("%d %d\n", j, i);
end
end
...
if set == 2
for i = 1:num
    Regret(:, 1) = Regret(:, 1) + Thompson2(data, 0)/num;
    fprintf("%d %d\n", j, i);
end
j = j + 1;
for i = 1:num
    Regret(:, 2) = Regret(:, 2) + Thompson2(data, 1)/num;
    fprintf("%d %d\n", j, i);
end
j = j + 1;
for i = 1:num
    Regret(:, 3) = Regret(:, 3) + Thompson2_ensemble(data, N, 0)/num;
    fprintf("%d %d\n", j, i);
end
j = j + 1;
for i = 1:num
    Regret(:, 4) = Regret(:, 4) + Thompson2_ensemble(data, N, 1)/num;
    fprintf("%d %d\n", j, i);
end
end
